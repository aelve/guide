      ...
      <template v-if="resultsItems && resultsItems.length">
        ...
        >
          ...
          <v-card-title class="flex-column align-baseline">
            ...
            <div class="search-results__result-parent-wrap">in <router-link :to="`/haskell/${result.contents.category.id}`" class="search-results__result-parent-title">{{result.contents.category.title}}</router-link></div>
