...
sampleState = do
  ...
  let microlensItem = Item {
        ...
        _itemKind = Library (Just "microlens") }
  ...
  let megaparsecItem = Item {
        ...
        _itemNotes = "",
        _itemLink = Nothing,
        _itemKind = Library (Just "megaparsec") }
  let attoparsecItem = Item {
        ...
        _itemNotes = "",
        _itemLink = Nothing,
        _itemKind = Library (Just "attoparsec") }
